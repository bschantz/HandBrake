...
enum
{
    ...
    HB_GID_VCODEC_VP8,
    HB_GID_VCODEC_VP9,
    HB_GID_VCODEC_NVENC_H264,
    HB_GID_VCODEC_NVENC_H265,
    HB_GID_ACODEC_AAC,
...
hb_encoder_internal_t hb_video_encoders[]  =
{
    ...
    { { "H.264 (NVEnc)",       "h264_nvenc", "H.264 (NVidia SDK)",      HB_VCODEC_NVENC_H264,   HB_MUX_MASK_MP4|HB_MUX_MASK_MKV, }, NULL, 1, HB_GID_VCODEC_H264,   },
    ...
    { { "H.265 (NVEnc)",       "h265_nvenc", "H.265 (NVidia SDK)",      HB_VCODEC_NVENC_H265,   HB_MUX_MASK_MP4|HB_MUX_MASK_MKV, }, NULL, 1, HB_GID_VCODEC_H265,   },
